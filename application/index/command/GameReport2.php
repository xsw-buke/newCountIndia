...
//use think\Db;
//
//class GameReport2 extends Command
//{
//
//	//TODO::测试没有提速 有点问题
//	//压注消耗
...
//		$this->setName ( 'GameReport2' )// 运行命令时使用 "--help | -h" 选项时的完整命令描述
//		     ->setDescription ( '生成游戏小时报表2' )/**
//		 * 定义形参
...
//						'spin_count'                => 0,//默认数值
//						'spin_get'                  => 0,//默认数值
//						'free_spin_get'             => 0,//默认数值
//						'free_spin_count'           => 0,//默认数值
//						'tiny_game_get'             => 0,//默认数值
//						'tiny_game_count'           => 0,//默认数值
//						'free_spin_tiny_game_get'   => 0,//默认数值
//						'free_spin_tiny_game_count' => 0,//默认数值
//					];
//					//新玩家统计入库
...
//		//获取报表
//		$group = $this->db_log->table ( 'tbl_gold_log_' . $this->dateYmd )
//		                      ->field ( [
//			                      'count(*) as count',
//			                      'sum(add_gold) as sum',
//			                      'esrc'
...
//				//押注消耗
//				case self::SPIN_COST;
//					$this->insertData  [ 'spin_cost' ] = abs ( intval ( $value[ 'sum' ] ) );
//					$this->insertData [ 'spin_count' ] = $value[ 'count' ];
//					break;
//				//压注获得
//				case self::SPIN_GET;
//					$this->insertData[ 'spin_get' ] = $value[ 'sum' ];
//					break;
//				//免费压注 获得金币 和次数
//				case self::FREE_SPIN_GET;
//					$this->insertData[ 'free_spin_get' ]   = intval ( $value[ 'sum' ] );
//					$this->insertData[ 'free_spin_count' ] = $value[ 'count' ];
//					break;
//				//小游戏获取得
//				case self::TINY_GAME_GET;
//					$this->insertData[ 'tiny_game_get' ]   = intval ( $value[ 'sum' ] );
//					$this->insertData[ 'tiny_game_count' ] = $value[ 'count' ];
//					break;
//				//免费押注小游戏获得
//				case self::FREE_SPIN_TINY_GAME_GET;
//					$this->insertData[ 'free_spin_tiny_game_get' ]   = intval ( $value[ 'sum' ] );
//					$this->insertData[ 'free_spin_tiny_game_count' ] = $value[ 'count' ];
//					break;
//				//新增游戏状态,小时玩家活跃状态 进来状态就是1 没走进来默认0
//			}
//		}
//
//		//		$get_sum = array_sum ( [
